...
public class Paddle
{
  ...
  public Paddle(int aMinimumLength, int aMaximumLength, int aWidthForPlayArea, int aHeightForPlayArea, Ball aBallForPlayArea, Game aGameForPlayArea)
  {
    minimumLength = aMinimumLength;
    maximumLength = aMaximumLength;
    playArea = new PlayArea(aWidthForPlayArea, aHeightForPlayArea, aBallForPlayArea, this, aGameForPlayArea);
  }
